...
public class Deportivo extends Sedan{
    ...
    public Deportivo(TipoCombustible tipoCombustible, TipoTrasmision tipoTrasmision, EsNuevo esNuevo,
        ...
        super(tipoCombustible, tipoTrasmision, esNuevo, tieneAireAcondicionado, tieneCapReversa, tieneVelCrucero, tieneABS,
                tieneSensoresColision, tieneSensoresCrucero, tieneAssiPermanencia, marca, modelo, cambios, velocidadMaxima,
